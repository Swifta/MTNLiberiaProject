...
public interface IFundamoPayment {
    ...
    public TransactionResponse receivePaymentConfirmation(String string, String string1, String string2, long l, String string3, String string4, String string5, String string6, String string7, String string8, String string9, String string10);
